                    ...
                    <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            ...
                            @if (Auth::user()->isAn('admin', 'scorer'))
                                <li ><a class="dropdown-item" href="{{ route('scores.index') }}">{{trans('app.scores')}}<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-list"></span></a></li>
                            @endif
                            <li class="dropdown">
